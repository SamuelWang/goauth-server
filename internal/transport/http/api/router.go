...
func RegisterRoutes(r *gin.Engine, cfg *config.Config, authService *auth.Service, userService *user.Service, providerService *provider.Service, clientService *client.Service, sessionService *session.Service) {
